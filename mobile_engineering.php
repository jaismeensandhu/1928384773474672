<html>
    ...
    <link rel="canonical" href="http://www.mentortechsource.com/mobile_engineering/"/>
    <link href="https://fonts.googleapis.com/css?family=Montserrat" rel="stylesheet">
    <meta name="description" itemprop="description" content="The Software Economy is growing at light speed and if you don’t want to be left behind you need the right company to help you implement Mobile and IOT strategies to get your company's.." />

    <meta name="keywords" itemprop="keywords" content="Canada IT, IT support, IT services, IT support Toronto, private server, Staffing Solutions, Mentor, Mentor Tech Source, IT staff provider, Toronto-based IT, IT management firm,IT consulting, Mobile Engineering, VoIP Toronto, Toronto IT service,Canada IT Consulting, VOIP, IT Jobs" />
	...
	<body>
			...
			<div class="wrapper">
				<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		            ...
		            <div class="video-container">
		                	<img src="images/banner/services_mobile_engineering_banner.jpg" alt="mentor_tech_soucre_services_mobile_engineering" height="400px" width="100%" style="object-fit:fill;">
			        </div>
                    		<div class="text" style="top:30%;right:20%;">
					<h1>Mobile Engineering<br></h1><p></p>
				</div>
	    		</div>
		</section>
		<section id="servicespg">
				...
				<a class="current" href="mobile_engineering.php">Mobile Engineering</a>
