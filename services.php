<html>
	<head>
    	...
    	<link rel="canonical" href="http://www.mentortechsource.com/services/"/>
    	<link href="https://fonts.googleapis.com/css?family=Montserrat" rel="stylesheet">
			...
			<div class="wrapper">
				<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
					...
					<?php include_once("includes/modal.php"); ?>
				        ...
				        <!-- <img src="images/banner/services_banner.jpg" alt="mentor_tech_source_services"> -->
			        </div>
                    		<div class="text">
					<h1>Services We Offer</h1><p>Mentor Tech Source Provides a Robust and Diverse set of Services in IT Staffing and Recruitment Out-Sourcing</p>
				</div>
	    		</div>
		</section>
