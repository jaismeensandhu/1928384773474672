<html>
    ...
    <link rel="canonical" href="http://www.mentortechsource.com/managed_services/"/>
    <link href="https://fonts.googleapis.com/css?family=Montserrat" rel="stylesheet">
...
<body>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse" style="float:right;">
                <ul class="nav navbar-nav">
		            ...
		            <div class="video-container">
		                <img src="images/banner/services_managed_services_banner.jpg" alt="services_managed_services_banner" height="400px" width="100%" style="object-fit:fill;">
			        </div>
                    <div class="text" style="top:40%;">
					    <h1 style="color:#fff;margin-bottom:.5rem;padding-bottom:.5rem;">Managed Services<br></h1><p  style="color:#fff;text-shadow: .2px .2px .5px #fff;font-size:1.5rem;"></p>
					</div>
	    </div>
	</section>
	...
	<section id="servicespg">
        <div class="subnav"><center>
					...
					<a class="current" href="managed_services.php">Managed Services</a><center>
	    </div>
