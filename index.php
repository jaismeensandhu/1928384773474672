<html>
	<head>
		<title>Mentor tech source Home Page</title>
		<link href="css/bootstrap.min.css" rel="stylesheet">
		<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/3.0.3/normalize.min.css">
		<link rel="stylesheet" href="css/styles.css">
		<link rel='shortcut icon' href='images/favicon.ico' type='image/x-icon'/>	
		<link href="https://fonts.googleapis.com/css?family=Montserrat" rel="stylesheet">
		<link rel="canonical" href="http://www.mentortechsource.com/home/"/>
		<link href="https://fonts.googleapis.com/css?family=Montserrat" rel="stylesheet">
		...
		<script>
			function show_alert() 
			{
				alert("Thank you. Our management team will contact you soon.");
			}
		</script>
		<meta charset="utf-8">
	...
	<body>
		...
		<section id="interact">
				...
				<div class="col-sm-4 divCS">
					...
					<a href="index.php#request"><h1>Contact Us</h1></a>
				</div>
			...
			<div  class="col-sm-4" id="contactUs" style="background-image:url('images/quick_query.jpg');float:right;">
				...
				?>
  				<form id="contact" method="post" action="">
    				<fieldset>
						<input placeholder="Request Title e.g. Job or Services" name="title" type="text" id="request" tabindex="1" required>
					</fieldset>
					<fieldset>
