<html>
	<head>
		<title>Mentor Tech Source - IT Staffing</title>
    ...
    <link rel="canonical" href="http://www.mentortechsource.com/it_staffing/"/>
    <link href="https://fonts.googleapis.com/css?family=Montserrat" rel="stylesheet">
	...
	<body>
				...
				<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
					...
					<?php include_once("includes/modal.php"); ?>
		            	<div class="video-container">
		                	<img src="images/banner/services_it_staffing_banner.jpg" alt="services_it_staffing_banner" height="450px" width="100%" style="object-fit:fill;top:15%;">
			        </div>
                    		<div class="text" style="top:15%;left:10%">
					<h1 style="text-shadow:1px 1px 1px 1px #000;"><br></h1><p></p>
				</div>
	    		</div>
		</section>
		...
		<section id="servicespg">
        		<div class="subnav"><center>
	            	<a class="current" href="it_staffing.php">IT Staffing</a>
        		...
        		<div class="col-md-6 servicespgs">
	        		<center><h2>IT Staffing Solutions</h2></center>
