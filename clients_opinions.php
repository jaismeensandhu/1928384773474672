<html>
    ...
    <link rel="canonical" href="http://www.mentortechsource.com/clients_opinions/"/>
    <link href="https://fonts.googleapis.com/css?family=Montserrat" rel="stylesheet">
	...
	<body>
			...
			<div class="wrapper">
				<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
					...
					<?php include_once("includes/modal.php"); ?>
				        ...
				        <!-- <img src="images/banner/clients_opinions_banner.jpg" alt="clients_opinions_banner"> -->
			        </div>
                		<div class="text">
					<h1>Mentor tech&gt;source work with many leading companies accross the globe</h1>
				</div>
			</div>
		</section>
		...
		<section id="servicespg">
        		<div class="subnav"><center>
	        		<a href="clients.php#our_clients">Our Clients</a>
				<a class="current" href="clients.php#clients_opinions">Cutomer Success Stories</a><center>
	    		</div> <!-- /.subnav -->
